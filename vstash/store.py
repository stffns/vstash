...
class VstashStore:
    ...
    def _mmr_dedup(
        ...
        # Initialize L2 norms lazily to avoid computing them for documents with no siblings
        ...
        for _ in range(min(top_k, len(ranked))):
            ...
            # Fast path: skip similarity updates entirely if this is the
            # only chunk from this document, as there are no siblings to penalize.
