...
class _SearchEngineMixin:
    ...
    def _mmr_dedup(
        ...
        # Lazily evaluate L2 norms for cosine similarity. We only compute
        # these if a chunk actually needs to be compared to a sibling.
        ...
        for _ in range(min(top_k, len(ranked))):
            ...
            # Fast path: bypass penalty updates entirely if the selected chunk
