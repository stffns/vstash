...
class _SearchEngineMixin:
    ...
    def _mmr_dedup(
        ...
        # Lazily evaluate L2 norms only when needed for similarity calculations.
        # This bypasses the overhead of computing hypotenuse for vectors that
        # never compete against siblings.
        ...
        for _ in range(min(top_k, len(ranked))):
            ...
            # If this document has no other siblings, skip the penalty update entirely.
            if len(siblings) <= 1:
                continue
