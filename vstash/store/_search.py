...
class _SearchEngineMixin:
    ...
    def _mmr_dedup(
        ...
        # Lazy initialization for L2 norms. They are only computed when
        # chunks are actually compared against siblings, avoiding O(N) overhead.
        ...
        for _ in range(min(top_k, len(ranked))):
            ...
            # Optimization: Skip penalty updates entirely if this is the only
            # remaining chunk from this document.
