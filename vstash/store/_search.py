...
class _SearchEngineMixin:
    ...
    def _mmr_dedup(
        ...
        # Lazily compute L2 norms for cosine similarity only when a chunk is compared
        # against a sibling. This avoids eagerly computing hypot() for single-chunk documents.
        ...
        for _ in range(min(top_k, len(ranked))):
            ...
            # Skip update if this document has no other chunks to penalize
